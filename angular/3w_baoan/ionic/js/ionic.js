 ...
 *
 * Portions lovingly adapted from github.com/maker/ratchet and github.com/alexgibson/tap.modules - thanks guys!
 */
...
(function(ionic) {
  ...
  ionic.EventController = {
     ...
     *
     * Available eventTypes (from [hammer.modules](http://eightmedia.github.io/hammer.modules/)):
     *
...
/**
  ...
  * gesture events.
  *
  * Ported from github.com/EightMedia/hammer.modules Gestures - thanks!
  */
(function(ionic) {
  ...
  ionic.Gestures.Instance.prototype = {
    ...
    /**
     * enable of disable hammer.modules detection
     * @param   {Boolean}   state
     * @returns {ionic.Gestures.Instance}
     */
  ...
  ionic.Gestures.event = {
    ...
    /**
     * collect event data for ionic.Gestures modules
     * @param   {HTMLElement}   element
     * @param   {String}        eventType        like ionic.Gestures.EVENT_MOVE
     * @param   {Object}        eventData
     */
  ...
  ionic.Gestures.utils = {
    ...
    stopDefaultBrowserBehavior: function stopDefaultBrowserBehavior(element, css_class) {
      ...
      // hammer.modules doesn't come with CSS, but ionic does, which is why we prefer this method
  ...
  ionic.Gestures.detection = {
     ...
     * @param   {Object}    gesture object, see gestures.modules for documentation
...
(function(window, document, ionic) {
  ...
  function onWindowLoad() {
    if (self.isWebView()) {
      // the window and modules are fully loaded, and a cordova/phonegap
      // object exists then let's listen for the deviceready
      document.addEventListener("deviceready", onPlatformReady, false);
    } else {
      // the window and modules are fully loaded, but the window object doesn't have the
 ...
 * - Multiple [unit tests](https://github.com/driftyco/ionic/blob/master/test/unit/utils/tap.unit.modules) for each scenario
 *
 */
/*
...
(function(ionic) {
   ...
   *
   * Some of these are adopted from underscore.modules and backbone.modules, both also MIT licensed.
   */
  ionic.Utils = {
    ...
    throttle: function(func, wait, options) {
     ...
     // Borrowed from Backbone.modules's extend
    ...
    // Extend adapted from Underscore.modules
    extend: function(obj) {
...
function viewportUpdate() {
  // unit tests in viewport.unit.modules
...
ionic.views.Scroll = ionic.views.View.inherit({
  ...
  */
  ...
  __initEventHandlers: function() {
    ...
    //See modules/utils/keyboard.modules
...
'use strict';
  ...
  var ReorderDrag = function(opts) {
    ...
    // Get the True Top of the list el http://www.quirksmode.org/modules/findpos.html
...
/*
 * Adapted from Swipe.modules 2.0
 *
 * Brad Birdsall
