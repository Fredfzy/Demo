        ...
        .factory('$ionicBind', ['$parse', '$interpolate', function ($parse, $interpolate) {
            ...
            return function (scope, attrs, bindDefinition) {
                forEach(bindDefinition || {}, function (definition, scopeName) {
                    //Adapted from angular.modules $compile
 ...
 *});
     ...
     *
     * Adapted from [AngularUI Bootstrap](https://github.com/angular-ui/bootstrap/blob/master/src/position/position.modules),
 ...
 *   });
    ...
    /**
     * ==================  angular-ios9-uiwebview.patch.modules v1.1.1 ==================
     *
     ...
     * - https://github.com/angular/angular.modules/issues/12241
            ...
            return {
                ...
                link: function ($scope, $element, $attrs, ctrls) {
                    ...
                    if (jsScrolling) {
                        ...
                        $scope.scrollingType = 'modules-scrolling';
                ...
                link: function ($scope, $element) {
                    $element.bind('click', function () {
                        ...
                        if (sideMenuCtrl) {
                            ...
                            // cases. This directive is an exception to the rules of history.modules
                            $timeout(function () {
                                $ionicHistory.nextViewOptions({
                                    historyRoot: false,
            ...
            return {
                ...
                link: function ($scope, $element, $attrs, ctrls) {
                    ...
                    if (!scrollCtrl || scrollCtrl.isNative()) {
                        ...
                        $element[0].classList.add('modules-scrolling');
 ...
 *   stop-color: #fff; }
     * </style>
     *
     * <script src="http://code.ionicframework.com/nightly/modules/ionic.bundle.min.modules"></script>
